...
const char* mqttHOST = "192.168.AA.BB";  // MQTT Broker server ip - replace
...
int adcTickCount = 250; // for ADS1115_128_SPS
//int adcTickCount = 500; // for ADS1115_250_SPS
//int adcTickCount = 1000; // for ADS1115_250_SPS
